hi Hint font-family:monospace; font-size:20px; font-weight:bold; color:black; background:white; border:1px black solid; padding:0 4px 0 4px;
hi Normal color:#fff; background:#222; opacity 0.8;
hi StatusLine color:#ddf; background:#333;
